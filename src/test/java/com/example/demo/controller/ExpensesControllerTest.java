...
class ExpensesControllerTest {
  ...
  void before() {
      ...
      mono = generator.nextObject(Expenses.class);
      flux = Arrays.asList(generator.nextObject(Expenses.class), generator.nextObject(Expenses.class));
