...
@WebMvcTest(value = ScreenController.class)
@Import(ScreenService.class)
...
class ScreenControllerTest {
  ...
  void before() {
      ...
      mono = generator.nextObject(Screen.class);
      flux = Arrays.asList(generator.nextObject(Screen.class), generator.nextObject(Screen.class));
