...
@WebMvcTest(value = PrintlocationController.class)
@Import(PrintlocationService.class)
@ExtendWith(SpringExtension.class)
@Scope("test")
class PrintlocationControllerTest {
  ...
  void before() {
      ...
      mono = generator.nextObject(Printlocation.class);
      flux = Arrays.asList(generator.nextObject(Printlocation.class), generator.nextObject(Printlocation.class));
