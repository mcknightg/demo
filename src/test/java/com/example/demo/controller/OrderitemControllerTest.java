...
class OrderitemControllerTest {
  ...
  void before() {
      ...
      mono = generator.nextObject(Orderitem.class);
      flux = Arrays.asList(generator.nextObject(Orderitem.class), generator.nextObject(Orderitem.class));
