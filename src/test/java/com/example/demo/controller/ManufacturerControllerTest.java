...
class ManufacturerControllerTest {
  ...
  void before() {
      ...
      mono = generator.nextObject(Manufacturer.class);
      flux = Arrays.asList(generator.nextObject(Manufacturer.class), generator.nextObject(Manufacturer.class));
