...
@WebMvcTest(value = SettingsController.class)
...
class SettingsControllerTest {
  ...
  void before() {
      ...
      mono = generator.nextObject(Settings.class);
      flux = Arrays.asList(generator.nextObject(Settings.class), generator.nextObject(Settings.class));
