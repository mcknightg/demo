...
@WebMvcTest(value = EstimateitemController.class)
@Import(EstimateitemService.class)
@ExtendWith(SpringExtension.class)
@Scope("test")
class EstimateitemControllerTest {
  ...
  void before() {
      ...
      mono = generator.nextObject(Estimateitem.class);
      flux = Arrays.asList(generator.nextObject(Estimateitem.class), generator.nextObject(Estimateitem.class));
