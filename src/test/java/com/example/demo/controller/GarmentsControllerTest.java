...
@WebMvcTest(value = GarmentsController.class)
@Import(GarmentsService.class)
@ExtendWith(SpringExtension.class)
@Scope("test")
class GarmentsControllerTest {
  ...
  void before() {
      ...
      mono = generator.nextObject(Garments.class);
      flux = Arrays.asList(generator.nextObject(Garments.class), generator.nextObject(Garments.class));
