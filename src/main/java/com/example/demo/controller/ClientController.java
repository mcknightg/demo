...
public class ClientController {
  ...
  public Client save(@RequestBody Map<String,Object> dto){
    ObjectMapper mapper = new ObjectMapper();
    return this.service.save(mapper.convertValue(dto,Client.class));
  }
  ...
  @ResponseBody
  @GetMapping(value = {"/client/search"}, produces = { "application/json" })
  public Page<Client> search(@RequestParam(value = "term",  defaultValue = "") String searchTerm,
